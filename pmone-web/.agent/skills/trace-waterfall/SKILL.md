...
## 3. 开发规范与实例参考
- 📖 [Waterfall 甘特图位置百分比算法与抽屉规范](file:///Users/xiao/Documents/xiao/YUHENG/Projects/link-analysis-web-dev/link-analysis-web/.agent/skills/trace-waterfall/references/waterfall-calc.md)
- 📖 [TypeAdapter 多源数据适配器模式实现标准](file:///Users/xiao/Documents/xiao/YUHENG/Projects/link-analysis-web-dev/link-analysis-web/.agent/skills/trace-waterfall/references/adapter-pattern.md)
